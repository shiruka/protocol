...
publishing {
  publications {
    val publication = create<MavenPublication>("mavenJava") {
      ...
      pom {
        name.set("Protocol")
        description.set("A protocol library to handle Minecraft: Bedrock Edition packets.")
        ...
        scm {
          connection.set("scm:git:git://github.com/shiruka/protocol.git")
          developerConnection.set("scm:git:ssh://github.com/shiruka/protocol.git")
          url.set("https://github.com/shiruka/protocol")
        }
      }
    }
