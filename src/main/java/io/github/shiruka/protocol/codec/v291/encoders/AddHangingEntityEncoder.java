...
public final class AddHangingEntityEncoder implements PacketEncoder<AddHangingEntity> {

  /**
   * the instance.
   */
  public static final AddHangingEntityEncoder INSTANCE = new AddHangingEntityEncoder();
