 ...
 */
@PacketId(72)
public final class GameRulesChangedEncoderV291
  extends PacketEncoder.Base<GameRulesChanged> {

  @Override
  public void decode(
    @NotNull final GameRulesChanged packet,
    @NotNull final CodecHelper helper,
    @NotNull final PacketBuffer buffer,
    @NotNull final MinecraftSession session
  ) {
    packet.gameRules(
      buffer.readArrayUnsignedInt(() -> helper.readGameRule(buffer))
    );
  }
  ...
  public void encode(
    ...
    buffer.writeArrayUnsignedInt(
      packet.gameRules(),
      value -> helper.writeGameRule(buffer, value)
    );
  }
}
