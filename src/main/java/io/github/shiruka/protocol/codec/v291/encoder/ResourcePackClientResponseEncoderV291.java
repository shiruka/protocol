 ...
 */
@PacketId(8)
public final class ResourcePackClientResponseEncoderV291
  extends PacketEncoder.Base<ResourcePackClientResponse> {

  @Override
  public void decode(
    @NotNull final ResourcePackClientResponse packet,
    @NotNull final CodecHelper helper,
    @NotNull final PacketBuffer buffer,
    @NotNull final MinecraftSession session
  ) {
    packet.status(
      ResourcePackClientResponse.Status.VALUES[buffer.readUnsignedByte()]
    );
